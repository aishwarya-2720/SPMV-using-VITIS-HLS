...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe D:/xilinx/minorproject/data/rotor1.mtx.csr | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spmv_kernel.autotvin.dat"
	set constFileTvOut       "spmv_kernel.autotvout.dat"
	set constFileHdlTvIn     "spmv_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "spmv_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
