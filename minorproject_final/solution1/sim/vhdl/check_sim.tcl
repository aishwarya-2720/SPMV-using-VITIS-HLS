...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.spmv_kernel.autotvin_gmem_0.dat"
         "c.spmv_kernel.autotvin_gmem_1.dat"
         "c.spmv_kernel.autotvin_values.dat"
         "c.spmv_kernel.autotvin_col_indices.dat"
         "c.spmv_kernel.autotvin_row_indices.dat"
         "c.spmv_kernel.autotvin_x.dat"
         "c.spmv_kernel.autotvin_y.dat"
         "c.spmv_kernel.autotvin_n.dat"
         "c.spmv_kernel.autotvin_m.dat"
         "c.spmv_kernel.autotvin_nnz.dat"
         "c.spmv_kernel.autotvout_gmem_0.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.spmv_kernel.autotvout_gmem_0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
