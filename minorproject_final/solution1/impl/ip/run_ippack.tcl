...
set Library     "hls"
set IPName      "spmv_kernel"
set Version     "0.0"
set DisplayName "Spmv_kernel"
set Revision    "0"
...
set xo_kernel_name "spmv_kernel"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/xilinx/minorproject_final/minorproject_final/solution1"
set debug_dir "D:/xilinx/minorproject_final/minorproject_final/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {spmv_kernel_faddfsub_32ns_32ns_32_5_full_dsp_1
...
set Interfaces {
    ap_clk {
        ...
        buses "m_axi_gmem_0 m_axi_gmem_1"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem_0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_0"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_0"
    ...
    m_axi_gmem_1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_1"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 26 II x}
...
source -notrace "D:/xilinx/vitis2020.1/Vitis/2020.1/common/scripts/ipxhls.tcl"
